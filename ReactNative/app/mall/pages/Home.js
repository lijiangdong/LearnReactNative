        ...
        return (
            <View style={{backgroundColor: '#f5f5f5', flex: 1}}>
                    ...
                    <View style={{flex: 1, justifyContent: 'center'}}>
                        <TouchableOpacity>
                            <View style={{justifyContent: 'flex-start', flexDirection: 'row', alignItems: 'center'}}>
                                <Image style={{width: 20, height: 26, marginLeft: 8}}
                                       source={require('../images/ic_home_top_location.png')}/>
                                <Text style={{color: 'white', fontSize: 13, marginLeft: 3}}>定位中</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                    <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
                        <Image style={{width: 32, height: 25}} source={require('../images/ic_home_top_icon.png')}/>
                    </View>
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    ...
                    <View>
                        <View
                            style={{paddingBottom: 10, paddingTop: 10, flexDirection: 'row', backgroundColor: 'white'}}>
                            <View style={{flex: 1}}>
                                <TouchableOpacity>
                                    <View style={styles.center_item_wrap}>
                                        <Image style={{width: 80, height: 100, alignSelf: 'center'}}
